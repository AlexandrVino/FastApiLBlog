...
class JwtTokensGateway(TokensGateway):
    ...
    def _encode(self, subject: str, expires_time: timedelta | None = None) -> str:
    ...
    async def create_token_pair(self, subject: str) -> TokenPairDto:
        ...
        access_token = self._encode(subject, self._config.access_token_expires_time)
        refresh_token = self._encode(subject, self._config.refresh_token_expires_time)
        return TokenPairDto(
